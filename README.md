# Using SQLAlchemy to plan the perfect vacations!

## Objective: 
Performed climate analysis for an specific area using Python, SQLAlchemy ORM queries, Pandas, and Matplotlib.
